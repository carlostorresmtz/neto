...
export default function IllustrationPainPoint1() {
  ...
  return (
    <LineArt width={140} height={92} viewBox="0 0 140 92">
      ...
      <line className="draw-line" pathLength={1} x1="42" y1="46" x2="82" y2="46" stroke={STROKE} strokeWidth="1" strokeLinecap="round" style={{ transitionDelay: "0.58s", opacity: 0.5 }} />
      <line className="draw-line" pathLength={1} x1="42" y1="54" x2="78" y2="54" stroke={STROKE} strokeWidth="1" strokeLinecap="round" style={{ transitionDelay: "0.66s", opacity: 0.5 }} />
      {/* accent line being hand-traced */}
      <line className="draw-line" pathLength={1} x1="42" y1="64" x2="64" y2="64" stroke={ACCENT} strokeWidth="2" strokeLinecap="round" style={{ transitionDelay: "0.8s" }} />
