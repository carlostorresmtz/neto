    ...
    <LineArt width={420} height={120} viewBox="0 0 420 120">
      ...
      {[46, 56, 66, 76].map((y, i) => (
        <g key={y}>
          ...
          <line className="draw-line" pathLength={1} x1="324" y1={y} x2={i % 2 === 0 ? 380 : 368} y2={y} stroke={STROKE} strokeWidth="1.5" strokeLinecap="round" style={{ transitionDelay: `${1.55 + i * 0.1}s`, opacity: 0.5 }} />
        </g>
      ))}
    </LineArt>
  );
